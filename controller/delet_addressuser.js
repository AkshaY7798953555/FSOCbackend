...
const delete_addressuser = async function (event) {
    ...
    if (result[0].count == 1) {
        mysql.query("delete from user_address where user_id ="+data.user_id
        )
        return {
            statusCode: 200,
            body: JSON.stringify({
...
module.exports.delete_addressuser = delete_addressuser
